...
identity_observations_router = _safe_import("routes.identity_observations", "router")
...
branch_revenue_router = _safe_import("routes.branch_revenue", "branch_revenue_router")
