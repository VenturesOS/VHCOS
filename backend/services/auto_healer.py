        ...
        if service_name == "mongodb":
            ...
            try:
                ...
                if redis:
                    ...
                    result = "redis not configured, cache clear not needed"
            except ImportError:
                result = "redis not installed, cache clear skipped (expected)"
            except Exception:
                result = "redis not configured, cache clear skipped (expected)"
