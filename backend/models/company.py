...
class FixedFeeLevel(BaseModel):
    """Level-based fixed fee commercial: a fixed amount per salary range."""
...
class CommercialModel(BaseModel):
    ...
    type: str  # "percentage", "fixed", "level_based", "fixed_level_based"
    ...
    fixed_fee_levels: Optional[List[FixedFeeLevel]] = None  # for fixed_level_based type
