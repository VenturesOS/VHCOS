...
if not BASE_URL:
    BASE_URL = "https://deployment-stabilize.preview.emergentagent.com"
...
class TestCORSConfiguration:
    ...
    def test_cors_origin_allowed(self):
        ...
        if cors_origin:
            ...
            assert cors_origin in ["*", "https://portal.vhc.in", "https://deployment-stabilize.preview.emergentagent.com"], \
