...
if not BASE_URL:
    BASE_URL = "https://performance-dash-22.preview.emergentagent.com"
...
class TestCORSConfiguration:
    ...
    def test_cors_origin_allowed(self):
        ...
        if cors_origin:
            ...
            assert cors_origin in ["*", "https://portal.vhc.in", "https://performance-dash-22.preview.emergentagent.com"], \
