...
if not BASE_URL:
    BASE_URL = "https://auto-publish-hub-1.preview.emergentagent.com"
...
class TestCORSConfiguration:
    ...
    def test_cors_origin_allowed(self):
        ...
        if cors_origin:
            ...
            assert cors_origin in ["*", "https://portal.vhc.in", "https://auto-publish-hub-1.preview.emergentagent.com"], \
