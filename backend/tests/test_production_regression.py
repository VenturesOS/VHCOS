...
if not BASE_URL:
    BASE_URL = "https://talent-platform-29.preview.emergentagent.com"
...
class TestCORSConfiguration:
    ...
    def test_cors_origin_allowed(self):
        ...
        if cors_origin:
            ...
            assert cors_origin in ["*", "https://portal.vhc.in", "https://talent-platform-29.preview.emergentagent.com"], \
