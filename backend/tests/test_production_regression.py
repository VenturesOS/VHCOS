...
if not BASE_URL:
    BASE_URL = "https://portal-training-docs.preview.emergentagent.com"
...
class TestCORSConfiguration:
    ...
    def test_cors_origin_allowed(self):
        ...
        if cors_origin:
            ...
            assert cors_origin in ["*", "https://portal.vhc.in", "https://portal-training-docs.preview.emergentagent.com"], \
