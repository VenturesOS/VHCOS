...
from routes import auth_router, public_router, files_router, admin_router, jobs_router, candidates_router, applications_router, settings_router, background_jobs_router, teams_router, referrals_router, commercials_router
...
# Endpoints: /api/settings, /api/alerts/preferences, /api/alerts/pause,
#            /api/alerts/resume, /api/alerts/whatsapp/opt-in,
#            /api/alerts/whatsapp/opt-out, /api/alerts/whatsapp/number,
#            /api/notifications/history, /api/admin/notifications/stats
