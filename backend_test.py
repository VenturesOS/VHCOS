...
class VHCTalentOSAPITester:
    def __init__(self, base_url="https://hr-platform-staging-1.preview.emergentagent.com"):
...
def main():
    ...
    print(f"🌐 Backend URL: https://hr-platform-staging-1.preview.emergentagent.com")
