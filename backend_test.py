...
class VHCTalentOSAPITester:
    def __init__(self, base_url="https://deployment-stabilize.preview.emergentagent.com"):
...
def main():
    ...
    print(f"🌐 Backend URL: https://deployment-stabilize.preview.emergentagent.com")
