...
class VHCTalentOSAPITester:
    def __init__(self, base_url="https://smart-resume-parser-1.preview.emergentagent.com"):
...
def main():
    ...
    print(f"🌐 Backend URL: https://smart-resume-parser-1.preview.emergentagent.com")
