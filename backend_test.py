...
class VHCTalentOSAPITester:
    def __init__(self, base_url="https://portal-training-docs.preview.emergentagent.com"):
...
def main():
    ...
    print(f"🌐 Backend URL: https://portal-training-docs.preview.emergentagent.com")
