...
// Simplified pipeline — Sourced → Submitted → Shortlisted → Interviewed → Offered → Hired → Joined
const STAGES = ['sourced', 'submitted_to_client', 'shortlisted', 'interview', 'offered', 'hired', 'joined', 'rejected', 'on_hold'];
  ...
  return (
    <div className="space-y-6" data-testid="applicants-page">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="font-heading text-xl sm:text-2xl lg:text-3xl font-bold text-slate-900">Applicants</h1>
