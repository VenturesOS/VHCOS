...
import { Upload, Database, Mail, Phone, MapPin, FileText, Clock, Briefcase, DollarSign, AlertCircle, CalendarDays, Activity, TrendingUp, Download, Info, EyeOff, Users, Files } from 'lucide-react';
                  ...
                  {activityHistory?.freshness && (
                    <div className="bg-slate-50 rounded-lg p-3 text-sm space-y-1">
                      ...
                      <div className="flex items-center gap-2 text-slate-600">
                        ...
                        Last Update: {activityHistory.freshness.last_profile_updated_at ? new Date(activityHistory.freshness.last_profile_updated_at).toLocaleDateString('en-IN', { timeZone: 'Asia/Kolkata' }) : 'Never'}
                      </div>
                    </div>
                  )}
