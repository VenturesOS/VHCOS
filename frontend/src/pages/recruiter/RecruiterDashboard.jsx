...
import { Briefcase, Users, TrendingUp, Clock, ClipboardList, Search, FileText, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function RecruiterDashboard() {
  ...
  // Revenue targets are visible to Admin and the team's Employer only
  // (user choice 2026-02). Recruiters no longer see a target box.
