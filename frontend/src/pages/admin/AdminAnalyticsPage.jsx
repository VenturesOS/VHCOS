...
const SOURCE_LABELS = { naukri_extension: 'Naukri Extension', bulk_import: 'Bulk Import', public_application: 'Public Application', admin: 'Admin', recruiter: 'Recruiter', employer: 'Employer' };
const STAGE_COLORS = { applied: '#64748b', shortlisted: '#2563eb', submitted_to_client: '#7c3aed', interview: '#8b5cf6', offered: '#d97706', hired: '#059669', joined: '#10b981', rejected: '#dc2626', on_hold: '#f59e0b' };
const STAGE_LABELS = { applied: 'Applied', shortlisted: 'Shortlisted', submitted_to_client: 'Submitted', interview: 'Interview', offered: 'Offered', hired: 'Hired', joined: 'Joined', rejected: 'Rejected', on_hold: 'On Hold' };
            ...
            {pieData.length === 0 ? <EmptyState msg="No source data" /> : (
              <>
                <ResponsiveContainer width="100%" height={200}>
                  <PieChart><Pie data={pieData} cx="50%" cy="50%" innerRadius={45} outerRadius={80} paddingAngle={2} dataKey="value">{pieData.map((_, i) => <Cell key={i} fill={COLORS[i % COLORS.length]} />)}</Pie><Tooltip formatter={(val) => [val, 'Captures']} /></PieChart>
                </ResponsiveContainer>
