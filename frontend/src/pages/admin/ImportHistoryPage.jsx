    ...
    <div className="space-y-6" data-testid="import-history-page">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-heading text-3xl font-bold text-slate-900">Import History</h1>
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{new Date(batchDetails.created_at).toLocaleString()}</p>
                  </div>
                  <div>
