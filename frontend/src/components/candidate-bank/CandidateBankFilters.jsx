    ...
    <div className="p-4 space-y-3" data-testid="candidate-bank-filters">
      ...
      {activeFilterCount > 0 && (
        <div className="flex flex-wrap gap-1.5 items-center" data-testid="active-filters">
          ...
          {filters.aiSource && <FilterChip label={`AI: ${filters.aiSource === 'runpod' ? 'RunPod' : filters.aiSource === 'anthropic' ? 'Anthropic' : filters.aiSource === 'emergent' ? 'Emergent' : filters.aiSource}`} onRemove={() => updateFilter('aiSource', '')} />}
