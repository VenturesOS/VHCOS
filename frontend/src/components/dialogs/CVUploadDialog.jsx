...
import { cvUploadAPI, jobAPI, candidateBankAPI } from '../../lib/api';
        ...
        if (selectedMandateId && selectedMandateId !== 'none' && candidateId) {
          try {
            ...
            if (typeof detail === 'string' && detail.includes('already linked')) {
              toast.info('Candidate was already linked to this mandate');
            } else {
              toast.warning('Saved candidate but failed to link to mandate');
            }
          }
        }
          ...
          <div className="space-y-4">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-3 space-y-2">
              ...
              <Select value={selectedMandateId} onValueChange={setSelectedMandateId}>
                <SelectTrigger data-testid="cv-mandate-select">
