...
const navItems = {
  admin: [
    ...
    { icon: Zap, label: 'LLM A/B Testing', path: '/admin/talent-search' },
  ...
  recruiter: [
    ...
    { icon: Zap, label: 'LLM A/B Testing', path: '/recruiter/talent-search' },
  ...
  employer: [
    ...
    { icon: Zap, label: 'LLM A/B Testing', path: '/employer/talent-search' },
