...
const navItems = {
  admin: [
    ...
    { icon: Zap, label: 'Talent Search (A/B)', path: '/admin/talent-search' },
  ...
  recruiter: [
    ...
    { icon: Zap, label: 'Talent Search (A/B)', path: '/recruiter/talent-search' },
  ...
  employer: [
    ...
    { icon: Zap, label: 'Talent Search (A/B)', path: '/employer/talent-search' },
